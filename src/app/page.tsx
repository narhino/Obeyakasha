 ...
 * - Logged-out: public-audience whispers only, pinned first, + Enter CTA.
 * - Signed-in subject: their level-filtered feed, pinned first, kneel intact.
  ...
  return (
    <main className="relative mx-auto min-h-dvh max-w-2xl px-4 pb-20">
      ...
      <section className="pt-8">
        ...
        <WhispersFeed items={items} signedIn={signedIn} />
      </section>
    </main>
  );
}
